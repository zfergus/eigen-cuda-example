...
if(TARGET eigen_cuda_example_warnings)
  return()
endif()

set(EIGEN_CUDA_EXAMPLE_FLAGS
    -Wall
    -Wextra
    -pedantic
...
add_library(eigen_cuda_example_warnings INTERFACE)

foreach(FLAG IN ITEMS ${EIGEN_CUDA_EXAMPLE_FLAGS})
  ...
  if(IS_SUPPORTED_${FLAG_VAR})
    target_compile_options(eigen_cuda_example_warnings INTERFACE ${FLAG})
  endif()
endforeach()
